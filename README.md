...
4. Go to **Variables** and add:
   ...
   | `ALLOWED_ORIGINS` | `https://smartlink-gules.vercel.app` ← use your exact Vercel origin, no trailing slash |
...
4. Add environment variable:
   ...
   | Variable | Value |
   |---|---|
   | `VITE_API_URL` | your backend URL, for example `https://smartlink-backend-1xvk.onrender.com` |

5. Click **Deploy** → copy your Vercel URL ✅
6. Back in Railway/Render → update `ALLOWED_ORIGINS` to your exact Vercel URL, for example `https://smartlink-gules.vercel.app` → auto-redeploys 🎉
